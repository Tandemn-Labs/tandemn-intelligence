...
_QUOTA_PRESETS: dict[str, QuotaPreset] = {
    "aws_l40s_roomy": QuotaPreset(
        ...
        cloud="aws",
        notes="Fast, forgiving demo preset with lots of L40S headroom.",
        instances=(
    ...
    "aws_mixed_demo": QuotaPreset(
        ...
        cloud="aws",
        notes="Mixed fleet with L40S, A100, and H100 so Koi can visibly choose.",
        instances=(
            InstancePreset("g6e.12xlarge", "L40S", 4, 48.0, 48, "G6E", 7.35),
    ...
    "aws_a100_tight": QuotaPreset(
        ...
        cloud="aws",
        notes="Constrained quota preset to make placement tradeoffs and scale-up capacity visible.",
        instances=(
            InstancePreset("p4de.24xlarge", "A100-80GB", 8, 80.0, 96, "P4DE", 40.96),
            InstancePreset("g6e.12xlarge", "L40S", 4, 48.0, 48, "G6E", 7.35),
        ),
